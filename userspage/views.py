    ...
    if request.method=='POST':
        ...
        if form.is_valid():
            ...
            if user is not None:
                ...
                messages.add_message(request,messages.ERROR,'please enter your login credentials')
...
def esewaverify(request,order_id,cart_id):
    if request.method == 'GET':
        ...
        if map_data.get('status')=='COMPLETE':
            ...
            order.save()
            cart.delete()
            messages.add_message(request,messages.SUCCESS,'Payment sussessful')
            return redirect('/myorder')
        else:
            messages.add_message(request,messages.ERROR,'Payment failed')
            return redirect('/myorder')
